...
from TableHelpers import swap_row_values
...
def listEditCtrl(table_id, grid: DataGrid, height=-1, **kwargs):
    ...
    with dpg.child_window(menubar=True, height=height):
        ...
        with dpg.group(horizontal=True):
            ...
            dpg.add_button(label="Up", arrow=True, direction=dpg.mvDir_Up, callback=_move_row_up)
            dpg.add_button(label="Down", arrow=True, direction=dpg.mvDir_Down, callback=_move_row_down)
